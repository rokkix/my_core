<div class="container">
    <button style="background-color: cornflowerblue"><a href="/admin/update/?id=<?php echo $article->id;?>">Изменить</a></button>
    <button style="background-color: red"><a href="/admin/delete/?id=<?php echo $article->id;?>">Удалить</a></button>
